...
format-links: [html, hikmah-pdf]   # Link-Namen müssen den Formatkeys entsprechen
format:
  html:
    toc: true
    toc-depth: 2
  ...
  hikmah-pdf:                       # benötigt: quarto add andrewheiss/hikmah-academic-quarto
    toc: true
    number-sections: false
---
...
Die beiden Beispielabbildungen stehen nebeneinander; in Texten kann darauf mit @fig-a bzw. @fig-b verwiesen werden (z. B. *siehe @fig-a*).
...
![Beispielbild A](../images/bayern-religion-sp.jpg){#fig-a}

![Beispielbild B](../images/bayern-religion2-sp.jpg){#fig-b}

Famous Elephants
:::

Textbezug: Die Struktur in @fig-a wirkt homogener als in @fig-b.
...
:::
::: {.g-col-5}
![](../images/notebook.jpg){#fig-skizze}
:::
:::
...
::: {.column width="33%"}
#### Mini-Kasten B
![Amazonas in Hessen](../images/gisma-11.jpg)
:::
::: {.column width="33%"}
#### Mini-Kasten C
